...
void uib_views_init() {
	if(!gst_uib_views.is_init) {
		...
		case e_resolution_SQUARE_320x320:
			uib_view1_config_delegate_portrait = &uib_view1_config_SQUARE_320x320_portrait;
			g_view1_config_name_portrait = "common";
			uib_view1_config_delegate_landscape = &uib_view1_config_SQUARE_320x320_portrait;
